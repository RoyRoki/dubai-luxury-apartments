...
interface ViewingFormCardProps {
    onClose?: () => void
    isModal?: boolean
}

export default function ViewingFormCard({ onClose, isModal = false }: ViewingFormCardProps) {
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 overflow-hidden rounded-2xl border border-bronze-600/10 bg-obsidian-900/50 backdrop-blur-sm shadow-2xl relative">
